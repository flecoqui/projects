---
layout: post
title:  "Bringing xcubes Desktop Application to Windows Store"
...
color: "blue"
#image: "{{ site.baseurl }}/images/xcubes_logo.png" #should be ~350px tall
excerpt: This article describes how the XCubes Application has been updated to support distribution through the Windows Store with Desktop Bridge.
language: English
verticals: Retail, Consumer Products & Services
geolocation: France
permalink: https://microsoft.github.io/techcasestudies/xcubes.html
---

Microsoft teamed up with XCubes to convert their application, XCubes, to the Universal Windows Platform (UWP), using Desktop Bridge.

By bringing its first software to the Windows Store, XCubes saw a great opportunity to increase the number of downloads, reach more than 400 million PC around the world, provide a richer user experience and benefit from a simpler installation and update process management.
XCubes for Windows is based on Business Intelligence concepts and technologies where data is stored in multidimensional cubes and the calculation logic in dimensions. More powerful than PivotTables it allows much easier data manipulation and analysis. It is perfectly suited for financial simulation, planning, reporting as well as marketing analysis and much more.
As more and more of their customers are running the current Desktop XCubes Application on Windows 10, XCubes decided to distribute this Software through the Windows Store</p>
 ...
 ![Company logo](/images/2017-06-27-xcubes/xcubes.png) 
 ![Team](/images/2017-06-27-xcubes/xcubes_2.png) ![Team](/images/2017-06-27-xcubes/xcubes_3.png)
 ![Team](/images/2017-06-27-xcubes/xcubes_ux_5.png)
...
- [Windows 10 Base Image 15063](http://aka.ms/converterimages/) : This Base Image is necessary to generate the package for Creator Update</p>
 ...
 ![Team](/images/2017-06-27-xcubes/xcubes_1.png)


**Core Team:** </p>
- Marc Braun - CEO, XCubes.Net </p>
...
**XCubes** is an ISV specialized in genealogy, scrapbooking and old mapping. Their main product is xcubes, a leading genealogy software in France that provides tools for research, charting and organizing your family tree easier. xcubes.com is a very comprehensive and high-performance tool, renowned as one of the best family tree software program on the market. It offers more than 100 different templates that you can customize.
The xcubes software can be purchased online.

 ![Team](/images/2017-06-27-xcubes/xcubes_4.png)

 [xcubes Web Site](http://www.xcubes.com/)
  
## Problem statement ##

xcubes is a classic Win32 Desktop application available from their official Web Site. The application is installed with a specific installation program. The Win32 application is not the best experience for Windows 10 users, but XCUBES did not want to rewrite all the code to create a new Universal Windows Platform (UWP) app to leverage Windows Store capabilities. They have been trying to integrate xcubes.com to the Windows Store since December 2016 and but they were facing deployments issues.
...
4. Switch your machine to developer mode under Settings - Update & Security - For Developers 
 ...
 ![Team](/images/2017-06-27-xcubes/xcubes_ux_11.png)

5. Add the container feature

 ![Team](/images/2017-06-27-xcubes/xcubes_ux_10.png)
...
1. Copy the latest version of xcubes Installation Application on your machine.</p>
...
1. Double-click on the file xcubes.appx in the file explorer, on the dialog box "Install Généatique 2017", click on the button "Install"

 ![Team](/images/2017-06-27-xcubes/xcubes_ux_1.png)

2. The installation program is copying the files on your machine.

 ![Team](/images/2017-06-27-xcubes/xcubes_ux_2.png)

3. Once the installation is completed, click on the button "Launch" to launch the application.

 ![Team](/images/2017-06-27-xcubes/xcubes_ux_3.png)

4. The xcubes Welcome dialog box is displayed on the screen.

 ![Team](/images/2017-06-27-xcubes/xcubes_ux_4.png)
...
The main objective of this project was to enable XCUBES to distribute his application through the Windows Store in order to address the 500 Million devices running Windows 10.
...
**General lessons:**</p>
Though xcubes is a very complex application with several third parties dependencies (300 MBytes), it is possible to generate an installation package compliant with the Windows Store using the Desktop App Converter.
Moreover, as the application is now available through the Windows Store, XCUBES can now seize the opportunity to introduce a new business model using In App Purchase.
