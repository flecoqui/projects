---
layout: post
title:  "Bringing studioscrap Desktop Application to Windows Store"
...
color: "blue"
#image: "{{ site.baseurl }}/images/studioscrap_logo.png" #should be ~350px tall
excerpt: This article describes how the studioscrap Dea Web site has been updated to support automated multi-languages substiles generation for training videos and to personalize the journey of each user amongst the catalog of MOOCs.
language: English
...
As more and more of their customers are running the current Desktop Scrapbooking Software on Windows 10, CDIP decided to distribute this Software through the Windows Store</p>
 ...
 ![Team](/images/2017-06-28-studioscrap/studioscrap_ux_5.png)
...
- [Windows 10 Base Image 15063](http://aka.ms/converterimages/) : This Base Image is necessary to generate the package for Creator Update</p>
 ...
 ![Team](/images/2017-06-28-studioscrap/studioscrap_1.png)
...
4. Switch your machine to developer mode under Settings - Update & Security - For Developers 
 ...
 ![Team](/images/2017-06-28-studioscrap/studioscrap_ux_11.png)

5. Add the container feature

 ![Team](/images/2017-06-28-studioscrap/studioscrap_ux_10.png)
...
2. The installation program is copying the files on your machine.
 ...
 ![Team](/images/2017-06-28-studioscrap/studioscrap_ux_2.png)
